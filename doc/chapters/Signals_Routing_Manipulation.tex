\chapter{\sffamily Signals, Routing and Signal Manipulation}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sffamily Signal Manipulation}
...
\begin{tikzpicture}[>=Stealth, thick, scale=0.8]
    ...
    \draw[->, rtl_bus={8}] (Slice) -- ++(1.5,0) node[right] {Byte\_1};
\end{tikzpicture}
\end{RTLexample}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sffamily Bus Styling}

    \subsection{\sffamily Description}
        To represent multi-bit data paths, \texttt{SimpleRTL} provides the \texttt{rtl\_bus} decoration. Applying this style to a path increases the line width and adds a diagonal slash at the midpoint, accompanied by a label indicating the bus width. 
...
\begin{tikzpicture}[>=Stealth, thick]
    ...
    \draw[->, rtl_bus={n}] (0,-1) -- (3,-1) node[right] {Generic\_Bus};
\end{tikzpicture}
\end{RTLexample}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{\sffamily Advanced Routing (Z and U Routes)}

    \subsection{\sffamily Description}
        Manual routing with standard TikZ coordinates can become tedious in complex diagrams. \texttt{SimpleRTL} introduces two specialized commands to automate common routing patterns:
    ...
    \subsection{\sffamily Parameters}
    \begin{center}
        \begin{tabular}{lp{8cm}}
        \toprule
