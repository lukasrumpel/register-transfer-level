...
\section{Common Attributes and Sizing}

To ensure visual consistency across complex RTL diagrams, \texttt{SimpleRTL} provides a unified set of sizing attributes. While standard TikZ parameters remain functional, using the dedicated \texttt{rtl\_*} keys is highly recommended to maintain a clean and semantic naming scheme throughout your source code.

\subsection*{Global Dimension Keys}
...
\subsection*{The Anchor Convention}
Connectivity is the backbone of any RTL diagram. \texttt{SimpleRTL} follows a predictable, hyphenated naming convention to make signal routing intuitive:
